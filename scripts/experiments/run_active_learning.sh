...
LOCALMAPPER_CGR_MP_CONTEXT="${LOCALMAPPER_CGR_MP_CONTEXT:-spawn}"
export MPLCONFIGDIR
...
echo "Using LOCALMAPPER_EQUIVALENCE_BACKEND=${LOCALMAPPER_EQUIVALENCE_BACKEND}"
if [[ "$LOCALMAPPER_EQUIVALENCE_BACKEND" == cgrtools* ]]; then

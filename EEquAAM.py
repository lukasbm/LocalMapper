...
#    The output includes a summary and files with equivalent/non-equivalent    #
#    reaction groups.                                                         #
#                                                                              #
#  - Input: plain-text csv *_aam.smiles file as specified above.               #
#                                                                              #
#  - Output: (1) a txt file with a summary indicating if the atom maps where   #
#    equivalent or not                                                        #
...
#    linear running time is included in the summary. The last two files are    #
#    reactions whose maps were all                                            #
...
#                                                                              #
#  - Expected output:                                                          #
#    (1) myFile_aam_summary.txt                                                #
#    (2) myFile_aam_out_alleq.smiles                                           #
#    (3) myFile_aam_out_noneq.smiles                                           #
#                                                                              #
#  - Notes:                                                                    #
#                                                                              #
...
for [eachReaction, eachMap] in allMaps:
    try:
        ...
        even = False
    if(not even):
        answer = "***** Found a bad or incomplete map, i.e., not bijective or not readable. Terminating before completing the analysis.\n"
    ...
    for eachMap in mappedSMILES[eachReaction]:
        ...
        for eachReactant in reactantsList:
            ...
            try:
                ...
                ps.smiles_helper.dekekulize(molecule, estimation_threshold = None, max_ring_size = None)
